...
<div class="container" style="width:100%; background-image: url('/library/Public/Common/background.jpg');">
	<div class="row">
		<div class="col-sm-4" style="position: relative;left: 100px" >
		...
		<div class="col-sm-8">
			<form action="" method="post">
				<h1 style="text-align: center;">普通用户添加</h1>
				<ul>
					<li>
						<label for="user_id">普通用户ID </label>
	                    <input type="text" name="user_id"  placeholder="请输入普通用户ID" id="user_id" size="35" class="home_input_style" />
					</li>
					<li>
						<label for="user_name">普通用户名 </label>
	                    <input type="text" name="user_name"  placeholder="请输入普通用户名" id="user_name" size="35" class="home_input_style" />
					</li>
					<li>
						<label for="user_password">初始化密码 </label>
	                    <input type="password" name="user_password"  placeholder="初始化密码" id="user_password" size="35" class="home_input_style" />
					</li>
					<li>
						<input type="submit" value="添加新用户" class="btn_input"/>
					    <input type="reset" value="重置" class="btn_input"/>
					</li>
				</ul>
			</form>
		</div>
