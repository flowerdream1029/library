...
<div class="container" style="width:100%; background-image: url('/library/Public/Common/background.jpg');">
	<div class="row">
		<div class="col-sm-2" style="position: relative;left: 100px" >
			...
			<ul>
				<li>
					<div style="font-size: 20px;">系统用户管理</div>
				</li>
				...
				<li>
					<div style="font-size: 20px;">图书类别管理</div>
				</li>
				<ul style="margin-right: 0px;">
					<li>
				...
				<li>
					<div style="font-size: 20px;">图书信息管理</div>
				</li>
				<ul style="margin-right: 0px;">
					<li>
				...
				<li>
					<div style="font-size: 20px;">图书借阅管理</div>
				</li>
				<ul style="margin-right: 0px;">
					<li>
		...
		<div class="col-sm-10">
			<form action="" method="post">
				<h1 style="text-align: center;">图书信息添加</h1>
				<table>
					<tr>
						<td width="80px"><label for="id">书ID</label></td>
	                    <td><input type="text" name="id"  placeholder="请输入要添加的书ID" id="id" size="35" class="home_input_style" /></td>
					</tr>
					<tr>
						<td><label for="name">书名</label>
	                    <td><input type="text" name="name"  placeholder="请输入要添加的书名" id="name" size="35" class="home_input_style" /></td>
					</tr>
					<trtr>
						<td><label for="author">作者</label>
	                    <td><input type="text" name="author"  placeholder="请输入书的作者" id="author" size="35" class="home_input_style" /></td>
					</tr>
					<tr>
						<td><label for="sort">书类</label>
	                    <td><input type="text" name="sort"  placeholder="请输入书类名" id="sort" size="35" class="home_input_style" /></td>
					</tr>
					<tr>
						<td><label for="chubanshe">出版社</label>
	                    <td><input type="text" name="chubanshe"  placeholder="请输入出版社名" id="chubanshe" size="35" class="home_input_style" /></td>
					</tr>
					<tr>
						<td><label for="code">编码</label>
	                    <td><input type="text" name="code"  placeholder="请输入书编码" id="code" size="35" class="home_input_style" /></td>
					</tr>
					<tr>
						<td><label for="position">所属区域</label>
	                    <td><input type="text" name="position"  placeholder="请输入书所属区域" id="position" size="35" class="home_input_style" /></td>
					</tr>
					</table>
						<input type="submit" value="添加新书" class="btn_input"/>
