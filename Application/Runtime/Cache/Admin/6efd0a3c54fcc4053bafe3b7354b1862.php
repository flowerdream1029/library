			...
			<form action="" method="post">
				...
				<table>
					<tr>
	                    ...
	                    <td><input type="text" name="old_pwd"  placeholder="旧密码" id="pwd" size="35" class="home_input_style" /></td>
					</tr>
					<tr>
						<td><label for="pwd">新密码：</label></td>
	                    <td><input type="password" name="new_pwd"  placeholder="新密码" id="pwd" size="35" class="home_input_style" /></td>
					</tr>
					<tr>
						<td><label for="pwd">确认新密码：</label></td>
	                    <td><input type="password" name="confirm_pwd"  placeholder="确认新密码" id="pwd" size="35" class="home_input_style" /></td>
					</tr>
					</table>
						<input type="submit" value="修改" class="btn_input"/>
